...
public class Main extends JFrame {
    ...
    public void addComponentsToPane(final Container pane) {
        ...
        menu.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                JOptionPane.showMessageDialog(pane, 
                        "UNIVERSIDADE SENAC DO ESTADO DO RIO GRANDE DO SUL - Porto Alegre\n"+
                        "DEPARTAMENTO DE ANALISE E DESENVOLVIMENTO DE SISTEMAS\n"+
                        "DISCIPLINA: Topicos Avancados\n"+
                        "PROFESSORA: Guilherme\n\n"+
                        "ALUNA: Mariana Bianchini" +
                        "ANALISADOR ALFABETICO\n\n"+
                        "Sistema feito para a obtenção da nota da primeira unidade de Compiladores.\n" +
                        "Data da Última Correção: 13/10/2018"
                        );
            }
        });
        c.fill = GridBagConstraints.HORIZONTAL;
        ...
        botaoCompilar.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                AnalisadorAlfabetico analisa = new AnalisadorAlfabetico();
    ...
    private static void createAndShowGUI() {
        ...
        Main frame = new Main();
        frame.setTitle("ANALISADOR ALFABETICO");
